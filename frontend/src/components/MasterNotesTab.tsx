...
import { CommitNote, ListNotes } from '../../wailsjs/go/main/App';
...
export default function MasterNotesTab({ caseId, evidenceItems, onEvidenceClick }: MasterNotesTabProps) {
    ...
    const handleCommit = async () => {
        ...
        setError('');
        try {
            await CommitNote({ case_id: caseId, content: content.trim() } as services.CommitNoteRequest);
            setContent('');
            fetchNotes();
        } catch (err: unknown) {
